...
public class Principal {
    public static void main(String[] args) {
        ...
        while(respuesta != 'n' && respuesta != 'N') {
            ...
            System.out.println("Ingrese radio del circulo que quiera ingresar: ");
            double radio = scanner.nextDouble();
            
            objCirculo = new Circulo(radio);            
            listaCirculos.addCirculo(objCirculo);
            
            System.out.println("Circulo añadido correctamente...");
            System.out.println("La superficie añadida" + objCirculo.getSuperficie());
